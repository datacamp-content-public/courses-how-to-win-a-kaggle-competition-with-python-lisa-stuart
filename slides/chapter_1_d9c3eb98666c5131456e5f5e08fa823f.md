...
`@script`
Previously, you created a predictive modeling template.  Let’s apply it to the Decision Tree algorithm which is a non-parametric supervised learning method that creates a series of binary splits on the features in a dataset.
